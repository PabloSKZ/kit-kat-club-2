...
ActiveRecord::Schema.define(version: 2020_03_10_154618) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "cart_item_joint_tables", force: :cascade do |t|
    t.bigint "cart_id"
    t.bigint "item_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cart_id"], name: "index_cart_item_joint_tables_on_cart_id"
    t.index ["item_id"], name: "index_cart_item_joint_tables_on_item_id"
  end
